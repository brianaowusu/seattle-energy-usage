# Project Title 
This project simulates a real-world data pipeline for analyzing energy efficiency in Seattle, including data cleaning, validation, KPI development, and dashboard reporting.
